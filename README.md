...
| ![대댓글 작성](https://github.com/user-attachments/assets/f26b57de-c4b8-4b17-ac36-83d61e0093c6) | gif2  | gif3  | ![대댓글 하트 do, undo](https://github.com/user-attachments/assets/68c6a1db-ef04-4b2c-9986-c6ee38ac2a44) |
| :-:| :-: | :-: | :-: |
| `상세 화면 포스트 대댓글 추가` | `포스트 대댓글 업데이트` | `포스트 대댓글 삭제` | `대댓글 하트 do, undo` |

#### [타인의 댓글, 대댓글 옵션 선택하는 경우 #1, #2, #3] [자신의 댓글, 대댓글 옵션 선택할 경우 #4]

| gif1 | gif2  | gif3  |gif3  |
| :-:| :-: | :-: |:-: |
| `대댓글 차단 #1` | `댓글 차단(대댓글 존재(O))#2` | `댓글 차단상태-> 마지막 대댓글 차단#3` |`편집하기 or 댓글 삭제#4` |
