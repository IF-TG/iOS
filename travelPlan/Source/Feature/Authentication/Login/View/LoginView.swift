...
final class LoginView: UIView {
  ...
  private let firstDescriptionLabel = UILabel().set {
    ...
    $0.font = .init(pretendard: .medium_500, size: Const.fontSize)
  ...
  private lazy var policyLabel: UILabel = .init().set {
    ...
    $0.font = .init(pretendard: .regular_400, size: Const.fontSize)
    $0.text = Const.text
    $0.textColor = .white
...
extension LoginView {
  ...
  private func setAttributedTextOfloginDescriptionLabel(_ label: UILabel) {
    ...
    let firstAttrs: [NSAttributedString.Key: Any] = [
      .font: UIFont(pretendard: .bold_700, size: 24) ?? .systemFont(ofSize: 24),
