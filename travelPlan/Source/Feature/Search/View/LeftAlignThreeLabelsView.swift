...
final class LeftAlignThreeLabelsView: UIStackView {
  ...
  private let titleLabel: UILabel = UILabel().set {
    $0.font = .init(pretendard: .semiBold_600, size: Constant.TitleLabel.fontSize)
    $0.text = "n/a"
  ...
  private let secondLabel: UILabel = UILabel().set {
    $0.font = .init(pretendard: .medium_500, size: Constant.SecondLabel.fontSize)
    $0.textColor = .yg.gray6
    $0.text = "n/a"
  ...
  private let thirdLabel: UILabel = UILabel().set {
    $0.font = .init(pretendard: .medium_500, size: Constant.ThirdLabel.size)
    $0.text = "n/a"
    $0.textColor = .yg.gray6
