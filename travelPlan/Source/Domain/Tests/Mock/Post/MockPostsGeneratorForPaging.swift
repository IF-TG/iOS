...
import Alamofire
import Combine
/// 임시적으로 에셋에 저장된 데이터 가져오기위해 선언했습니다.
import UIKit

final class MockPostsGeneratorForPaging {
  ...
  func searchPosts(
    keyword: String, page: Int32, perPage: Int32, isTitle: Bool, isContent: Bool
  ...
  private var titles: [String] {
    ["Capturing the Beauty of Ocean Bliss", "영롱한 바다", "거, 갈땐 가더라도 커피 한잔 정도는 괜찮잖나..", "맛과 향의 여행",
  ...
  private var userNames: [String] {
    ["Wanderlust_Journey", "SoulRebel", "용감한모험가", "커피맨", "모던스타일", "네트워킹마스터", "알고리즘 전문가", "concurrency Master", "자 가보자고~",
     "Wanderlust_Journey", "SoulRebel", "용감한모험가", "커피맨", "모던스타일", "네트워킹마스터", "알고리즘 전문가", "concurrency Master", "자 가보자고~"]
  }
  
  private var durationArray: [String] {
    ["한달", "7일", "3일", "12일", "60일", "7일", "14일", "20일", "2일",
     "한달", "7일", "3일", "12일", "60일", "7일", "14일", "20일", "2일"]
  }
  
  private var ymdArray: [String] {
    ["2023.03.16 ~ 2023.04.15", "2023.04.03 ~ 2023.04.09", "2023.04.17 ~ 2023.04.19",
     "2023.03.19 ~ 2023.03.30", "2023.03.15 ~ 2023.05.13", "2023.03.18 ~ 2023.03.24", "2023.03.07 ~ 2023.03.20", "2023.04.03 ~ 2023.04.22", "2023.04.11 ~ 2023.04.12",
     "2023.03.16 ~ 2023.04.15", "2023.04.03 ~ 2023.04.09", "2023.04.17 ~ 2023.04.19",
     "2023.03.19 ~ 2023.03.30", "2023.03.15 ~ 2023.05.13", "2023.03.18 ~ 2023.03.24", "2023.03.07 ~ 2023.03.20", "2023.04.03 ~ 2023.04.22", "2023.04.11 ~ 2023.04.12"]
  }
  ...
  private var postContentTexts: [String] {
    ["여름 여름 여름 여름~~~~ ",
     ...
     "출발전 모로코 지진소식으로 가족과 지인들의 우려속에 불안한 마음으로 출발했는데 민선예 인솔자님과 유범상 현지가이드님 덕분에 안전하고 편한하게 여행을 마무리할수 있었습니다",
  ...
  private func loadImage(named name: String) -> Data? {
    if let cachedData = imageCache[name] {
      return cachedData
    }
