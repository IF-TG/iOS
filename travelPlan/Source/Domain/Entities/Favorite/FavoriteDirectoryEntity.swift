...
final class FavoriteDirectoryEntity: Object {
  ...
  /// 디렉터리의 대표 이미지
  @Persisted private var imageThumbnails = List<Data>()
  
  /// 내부 디렉터리에서 보여질 수 잇는 데이터들의 id만 저장합니다.
  /// 이는 찜 바텀시트가 ui가 올라올 때 유용합니다. (이미 찜해져있는지 여부를 파악해야합니다.)
  @Persisted private var postIdentifiers = List<PostIdentifier>()
  @Persisted private var destinationIdentifiers = List<Int64>()
