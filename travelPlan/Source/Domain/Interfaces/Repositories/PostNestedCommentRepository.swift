...
protocol PostNestedCommentRepository {
  ...
  func deleteNestedComment(nestedCommentId: Int64) -> Future<Bool, Error>
  func toggleCommentHeart(nestedCommentId: Int64) -> Future<ToggledPostCommentHeartEntity, Error>
}
